      ...
      <body className={inter.className}>
        ...
        <header className="mb-16">
          ...
          <Link href={'/'} className="inline-flex gap-1 items-center" >
            <FontAwesomeIcon className="h-8 text-purple-400" icon={faCommentsDollar} />
            <span className="mt-2"> Tip your creator </span>
          </Link>
          ...
          <nav className="mt-2 flex gap-6 items-center">
            ...
            <div className="flex gap-4">
              ...
              <button className="bg-purple-300 rounded-full px-4 py-2">
                Sign up
              </button>
            </div>
